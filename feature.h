...
void Feature::deletionFeature(double percent_diff, int max_diff) {
    fprintf(stderr, "[SVfeature_feature] Collecting features of variations.\n");
    ...
    for(int i = 0; i < indelList->indelCnt; i++) {
        fprintf(stderr, "[SVfeature_feature] the %d variation is processing...", i + 1);
    ...
    fprintf(stderr, "[SVfeature_feature] Total features of %d variations collected.\n", indelList->indelCnt);
}
